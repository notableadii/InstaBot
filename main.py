...
RESPONSE_DELAY = random.randint(60, 90)  # Seconds to wait before responding
...
class InstagramCoupleBot:
    ...
    def generate_response(self, message):
        ...
        try:
            ...
            dont Use emojis. Don't mention you're an AI. Message her like a real human being, keep the texts in lowercase, and use keywords like
            - cutie like call her cutie time to time, bbg which means babygirl i call her that sometimes and respond to her in a genz style but dont overdo it keep it natural 
    ...
    def start_monitoring(self):
        ...
        try:
            while True:
                ...
                time.sleep(random.randint(60, 90))  # 2-10 minutes instead of 30 seconds
